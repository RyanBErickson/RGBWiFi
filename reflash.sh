...
#sudo python ../esptool/esptool.py --port /dev/ttyUSB0 --baud 9600 write_flash 0x40000080 ../firmware/NodeMCU\ Custom\ Build/nodemcu-master-9-modules-2015-08-10-01-56-53-integer.bin
